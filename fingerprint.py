...
class Fingerprint:
    ...
    def draw_hull(self, P, title = "Convex Hull", savefig = True,
                        xlabel = "P1", ylabel="P2"):
            ...
            for j in range (nD): 
                ...
                for k in range(nE):
                    ...
                    for w in range(nL):
                        l = Ls[w]
                        if solve==0:
                            P = self.solve_clarke2016(y,d,e,l, normalize=True)
                        elif solve==1:
    ...
    def report(self, infos, coefs_var, areas_medias):
        ...
        print ("Desvios padrão:", np.round(coefs_var,3))
